/* Zotero Git Sync -- deciding what a sync should do with each file
 *
 ...
 *
 * Only the base can tell "changed in Zotero" from "changed in the repository", so it is
